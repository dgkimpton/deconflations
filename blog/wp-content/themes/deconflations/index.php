...
if (isset($category_name) && !empty($category_name))
	$postArgs['category_name'] =$category_name;
else
	$postArgs['category_name'] ='blog';
...
<!-- Begin Post -->
<div class="post">
	<a href="<?php bloginfo('home'); ?>/?year=<?php the_time('Y'); ?>"><img class="postDate"
    	 																	src="<?php bloginfo('template_url'); ?>/<?php the_time('Y'); ?>.png" /></a>
	...
	?>>
		<div class="postContent">
            ...
            <div class="tags">
          		<span>see&nbsp;also</span>
                <ul class="tagList">
                    <?php the_tags('<li class="tagItem">', '</li><li class="tagItem">', '</li>'); ?>
                </ul>
            </div>
		</div>
